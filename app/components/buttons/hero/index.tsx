...
const ButtonHero = () => {
  return (
    ...
    <div className='flex grow flex-col justify-center items-center gap-4 sm:flex-row'>
      <Link href="/calendar" className='bg-accentPrimary flex flex-row justify-center items-center gap-3 rounded-2xl px-4 py-2 hover:bg-accentPrimaryHover focus:bg-accentPrimaryFocus w-full max-w-96 sm:max-2xl:basis-1/2 sm:max-2xl:max-w-72 transition-all duration-300 ease-in-out'>
